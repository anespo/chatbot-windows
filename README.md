...
- Navigate to `tony-bot` folder
- Select `tony-bot.bot` file
...
msbot clone services --name "tony-bot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
